...
public class PinnedAmplitudeClient extends AmplitudeClient {
    ...
    protected static String TRUST_STORE_PASSWORD = "This.Is.Password";
    protected static String TRUST_STORE_FILENAME = "/res/raw/comodotruststore.bks";

    /**
     * Pinned certificate chain for api.amplitude.com.
     */
    protected static final SSLContext SSL_CONTEXT_API_AMPLITUDE_COM = new SslContextBuilder()
    ...
    protected SSLSocketFactory getPinnedCertSslSocketFactory(SSLContext context) {
    ...
    protected void makeEventUploadPostRequest(OkHttpClient client, String events, final long maxId) {
        client.setSslSocketFactory(getPinnedCertSslSocketFactory());

...
2. [Download the jar](https://github.com/amplitude/Amplitude-Android/raw/master/amplitude-android-2.13.3-with-dependencies.jar) and copy it into the "libs" folder in your Android project in Android Studio.

  Alternatively, if you are using Maven in your project, the jar is available on [Maven Central](http://search.maven.org/#artifactdetails%7Ccom.amplitude%7Candroid-sdk%7C2.13.3%7Cjar) using the following configuration in your pom.xml:
